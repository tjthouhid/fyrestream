...
if (isset($_POST['submit'])) {
  ...
  $structure = "
    ...
    (36, 'geolocation_key', 'AIzaSyAqNpEUyL65fOFI8gtNMpxdL046waHjWgI'),
    (37, 'gif_enabled', '1'),
    (38, 'giphy_key', 'wm4UYHM6lxPzkM5ZxKeBn5Si9OGqSQog'),
    (39, 'post_translation_enabled', '1'),
    (40, 'yandex_key', 'trnsl.1.1.20180401T143334Z.343461c1bd2787eb.eb0f9c7e21f5bfdbb8f6f1bace43d2053fb4354a'),
    ...
    (71, 'facebook_appid', '2320843264906927'),
    (72, 'facebook_secret', '99c5667e18f4d3704c050132753db0b6'),
    (73, 'google_login_enabled', '1'),
    (74, 'google_appid', '594017739497-jj7ljqbvkeqa797mcthdlooqb4l70jm1.apps.googleusercontent.com'),
    (75, 'google_secret', 'S_uZST6MobErgZR0a6SHdiET'),
    (76, 'twitter_login_enabled', '0'),
    (77, 'twitter_appid', ''),
    (78, 'twitter_secret', ''),
    (82, 'linkedin_login_enabled', '1'),
    (83, 'linkedin_appid', '78ypfly8m9ilg3'),
    (84, 'linkedin_secret', 'fuPNYEtI79T7JP7j'),
    (85, 'vkontakte_login_enabled', '1'),
    (86, 'vkontakte_appid', '51580005'),
    (87, 'vkontakte_secret', 'RaOEfP7fe5fMcDwcuWlQ'),
    (88, 'email_smtp_enabled', '1'),
    (89, 'email_smtp_authentication', '1'),
    (90, 'email_smtp_ssl', '1'),
    (91, 'email_smtp_server', 'smtp.sendgrid.net'),
    (92, 'email_smtp_port', '465'),
    (93, 'email_smtp_username', 'apikey'),
    (94, 'email_smtp_password', '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'),
    (95, 'email_smtp_setfrom', 'info@zamblek.com'),
    ...
    (104, 'twilio_sid', 'AC86ddabf396431f46a9ac112ff0948ecc'),
    (105, 'twilio_token', ''),
    (106, 'twilio_phone', ''),
    (107, 'twilio_apisid', 'SK6accd44e3fb216fdf450bb522bad8292'),
    (108, 'twilio_apisecret', 'g4AQR42QJhkF9oA2g5213HMJyO4B1C3x'),
    (109, 'system_phone', ''),
    (110, 'chat_enabled', '1'),
    ...
    (147, 'ftp_path', './'),
    (148, 'ftp_endpoint', ''),
    (149, 'session_hash', '7ChViFpZx-4ouem-2sBeF-4oVpl-2mKzb-22b50ae9fb7c'),
    ...
    (163, 'paypal_id', 'AdVWlIfLak-mx1LpVM0Hx70_Pjq8Pc2jsm_yDa2SpT2y1Pv05MNkgbT3gwl2sNNfgNqp9z-8V04HsPty'),
    (164, 'paypal_secret', 'EKgs8t6e8iTuTcAeWgt8oEpoj56bnxM6rzOrtsw5R7Af22Y3TasP5ib58yFccX1Q_D07f95GxqaGUB03'),
    (165, 'creditcard_enabled', '1'),
    (166, 'alipay_enabled', '1'),
    (167, 'stripe_mode', 'test'),
    (168, 'stripe_test_secret', 'sk_test_P4VU8KVaarx5U4xGrD4vGFkA'),
    (169, 'stripe_test_publishable', 'pk_test_7KNcP5cpJlrHDgEu6ubc35Nx'),
    (170, 'stripe_live_secret', 'sk_live_VAzXLmar81ESqZJJVGm7a27u'),
    (171, 'stripe_live_publishable', 'pk_live_vbe3GLpdfhh6PJD8FTPrlZ69'),
    (172, 'coinpayments_enabled', '1'),
    (173, 'coinpayments_merchant_id', 'b74c6217596c221a16238e60ff911631'),
    (174, 'coinpayments_ipn_secret', 'abcdefg'),
    (175, '2checkout_enabled', '1'),
    (176, '2checkout_mode', 'sandbox'),
    (177, '2checkout_merchant_code', '901418106'),
    (178, '2checkout_publishable_key', '5108B0C1-BD1A-43CF-A4E2-429039C49D61'),
    (179, '2checkout_private_key', '74A018E0-E6C4-4F68-BCF5-E1CEB34D864F'),
    ...
    (263, 'adult_images_enabled', 'on'),
    (264, 'adult_images_action', 'blur'),
    (265, 'adult_images_api_key', 'AIzaSyCaPjyBOkw0wewx0yhHSKeYkdOONhifKCw'),
    ...
    (271, 'onesignal_app_id', 'd5ba0a2e-8aee-45dc-a655-3e34caf85309'),
    (272, 'onesignal_api_key', 'MGVhNThhYzQtYzY4OS00MGI5LWEzYmYtODI3OTViMmRlMjc1'),
    ...
    (297, 'agora_app_id', '98810f1d5d63403c82da97130282f3f2'),
    (298, 'agora_app_certificate', 'bbb989e5c2534e2baf8558ca004f0d16'),
    ...
    (339, 'paystack_enabled', '1'),
    (340, 'paystack_secret', 'sk_test_8c83d9ba1e0e93721dddf5137b55cede14110bb1'),
    ...
    (1199, 'razorpay_enabled', '1'),
    (1200, 'razorpay_key_id', 'rzp_test_bVeSL4jknpYD53'),
    (1201, 'razorpay_key_secret', 'JlDeoDxS0LL7Opi6RpuKzv6d'),
    (1214, 'cashfree_enabled', '1'),
    (1215, 'cashfree_mode', 'sandbox'),
    (1216, 'cashfree_client_id', '160128cd68e3f5e7a381580aa2821061'),
    (1217, 'cashfree_client_secret', 'TEST7eced525510991e60708b01636e71af6fe69abe'),
    (1228, 'coinbase_enabled', '1'),
    (1229, 'coinbase_api_key', 'ec307582-d046-4e57-90ae-562e73083b98'),
    (1238, 'securionpay_enabled', '1'),
    (1239, 'securionpay_api_key', 'pk_test_UognbzDeZqTaKtfWCvWyKzG5'),
    (1240, 'securionpay_api_secret', 'sk_test_UognboNeIOj38G8RRD87W2qJ'),
    ...
    (1292, 'ffmpeg_path', '/opt/homebrew/bin/ffmpeg'),
    ...
    (2129, 'moneypoolscash_enabled', '1'),
    (2130, 'moneypoolscash_api_key', 'Z2FtbWVyODExOTkwMDY2'),
    (2131, 'moneypoolscash_merchant_email', 'zamblek@outlook.com'),
    (2148, 'wordpress_login_enabled', '1'),
    (2149, 'wordpress_appid', '86374'),
    (2150, 'wordpress_secret', 'PoBKzDVDnOx0yN3kJ7fJsKUjzfRdFotwGe5xFzwRtiLFcj2OLybGlm4OzhpoTqUI'),
    (2244, 'moneypoolscash_merchant_password', 'uF6RWGq7e5WyMEq@'),
    ...
    (2454, 'sngine_login_enabled', '1'),
    (2455, 'sngine_appid', '79793190177594'),
    (2456, 'sngine_secret', 'd4d661d4ce307ac074266083f3630494'),
    (2499, 'sngine_app_domain', 'createscene.dev'),
    (2522, 'sngine_app_name', 'Sngine'),
    (2570, 'sngine_app_icon', 'photos/2023/07/sngine_a26a013324186b768482293d5eff62b0.png'),
    (2571, 'market_money_withdraw_enabled', '1'),
    (2572, 'market_payment_method', 'paypal,skrill,moneypoolscash,bank'),
    ...
    (2577, 'sms_limit', '3'),
    (2596, 'switch_accounts_enabled', '0'),
    ...
    --
    ALTER TABLE `system_options`
      MODIFY `option_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2598;
