...
try {
  ...
  switch ($_POST['handle']) {
    ...
    case 'subscribe':
      ...
      // get stripe session
      $return['session'] = stripe($_POST['method'], "subscribe", $monetization_plan['price'], $_POST['plan_id']);
      break;
    ...
    case 'movies':
      ...
      // get stripe session
      $return['session'] = stripe($_POST['method'], "movies", $movie['price'], $_POST['movie_id']);
      break;
