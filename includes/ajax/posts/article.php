...
try {
  ...
  switch ($_GET['do']) {
    case 'create':
      ...
      $post_id = $user->post_article($_POST['publish_to'], $_POST['page_id'], $_POST['group_id'], $_POST['event_id'], $_POST['title'], $_POST['text'], $_POST['cover'], $_POST['category'], $_POST['tags'], $_POST['tips_enabled']);
