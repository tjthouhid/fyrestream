                        ...
                        <div class="product-image">
                          <div class="product-price">
                            {if $cart_item['post']['product']['price'] > 0}
                              {print_money($cart_item['post']['product']['price'], $cart_item['post']['product']['symbol'], $cart_item['post']['product']['dir'])}
                            {else}
                              {__("Free")}
                            {/if}
                          </div>
            ...
            <div class="text-end">
              ...
              <p>
                <span class="text-xxlg">
                  {print_money(number_format($cart['total']), $system['system_currency_symbol'], $system['system_currency_dir'])}
                </span>
              </p>
            </div>
            <div class="divider"></div>
