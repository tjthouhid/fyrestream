                  ...
                  <div class="card card-pricing shadow-sm">
                    ...
                    <div class="card-body text-start">
                      <h2 class="price">
                        {if $package['price'] == 0}
                          {__("Free")}
                        {else}
                          {print_money(number_format($package['price']))}
                        {/if}
                      </h2>
                      <div>
                    ...
                    <ul class="list-group list-group-flush text-start">
                      ...
                      <li class="list-group-item">
                        ...
                        {else}
                          {include file='__svg_icons.tpl' icon="checked" class="mr10" width="24px" height="24px"}{__("Boost up to")} {number_format($package['boost_posts'])} {__("Posts")}
                        {/if}
                      </li>
                      <li class="list-group-item">
                        ...
                        {else}
                          {include file='__svg_icons.tpl' icon="checked" class="mr10" width="24px" height="24px"}{__("Boost up to")} {number_format($package['boost_pages'])} {__("Pages")}
                        {/if}
                      </li>
