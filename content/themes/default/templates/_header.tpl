...
<div class="main-wrapper">
   ...
   <div class="{if $system['fluid_design']}container-fluid{else}container{/if}">
      <div class="row g-0">
         <div class="col-md-4">
            <div class="row g-0">
               <div class="{if !$user->_logged_in}col-6{/if} col-md-4 col-lg-4 {if $user->_logged_in}d-none d-md-block{/if}">
                  <!-- logo-wrapper -->
               ...
               <!-- search-wrapper -->
               <div class="{if !$user->_logged_in}col-6{/if} col-md-8 col-lg-8 d-none d-md-block" >
                  <div class="row">
