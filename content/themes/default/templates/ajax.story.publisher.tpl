  ...
  <div class="modal-body">
    ...
    {if $user->_is_admin}
      <div class="form-table-row">
        ...
        <div>
          <div class="form-label h6">{__("Ads Moment")}</div>
          <div class="form-text d-none d-sm-block">{__("Share this Moment as ads so all users see it")}</div>
        </div>
        <div class="text-end">
