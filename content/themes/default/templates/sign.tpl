  ...
  <div class="row">
    <div class="col-12 col-md-2 order-1 order-md-1 mx-auto">
      <img class="logo img-fluid"
        src="{$system['system_url']}/content/themes/{$system['theme']}/images/icons/moments logo.svg"
        alt="Moments Logo" />
    </div>
    <div class="col-12 col-md-5 pt-5 px-4 pb-4 order-3 order-md-2">
      <div class="">
        {include file='_sign_form.tpl' do="up"}
    ...
    <div class="col-12 col-md-5 order-2 order-md-3">
      <img class="logo img-fluid"
        src="{$system['system_url']}/content/themes/{$system['theme']}/images/login-hero.png" />
    </div>
  </div>
</div>
