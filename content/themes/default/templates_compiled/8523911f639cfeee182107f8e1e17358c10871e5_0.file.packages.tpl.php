<?php
/* Smarty version 4.3.2, created on 2023-10-08 12:10:53
  from '/home1/fyrestr4/public_html/test.fyrestream.com/content/themes/default/templates/packages.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.2',
  'unifunc' => 'content_65229c4df1b9b5_23936639',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '8523911f639cfeee182107f8e1e17358c10871e5' => 
    array (
      0 => '/home1/fyrestr4/public_html/test.fyrestream.com/content/themes/default/templates/packages.tpl',
      1 => 1691868516,
      2 => 'file',
    ),
  ),
...
function content_65229c4df1b9b5_23936639 (Smarty_Internal_Template $_smarty_tpl) {
...
" style="max-width: 42px;">
                    ...
                    <div class="card-body text-start">
                      <h2 class="price">
                        ...
                        <?php } else { ?>
                          <?php echo print_money(number_format($_smarty_tpl->tpl_vars['package']->value['price']));?>
...
echo __("Posts promotion");?>
                        ...
                        <?php } else { ?>
                          <?php $_smarty_tpl->_subTemplateRender('file:__svg_icons.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('icon'=>"checked",'class'=>"mr10",'width'=>"24px",'height'=>"24px"), 0, true);
echo __("Boost up to");?>
 <?php echo number_format($_smarty_tpl->tpl_vars['package']->value['boost_posts']);?>
 <?php echo __("Posts");?>
...
echo __("Pages promotion");?>
                        ...
                        <?php } else { ?>
                          <?php $_smarty_tpl->_subTemplateRender('file:__svg_icons.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('icon'=>"checked",'class'=>"mr10",'width'=>"24px",'height'=>"24px"), 0, true);
echo __("Boost up to");?>
 <?php echo number_format($_smarty_tpl->tpl_vars['package']->value['boost_pages']);?>
 <?php echo __("Pages");?>
